...
pip install -I xformers==0.0.30 && pip install -r requirements && pip install -I bitsandbytes gradio tensorflow==2.15.0.post1 onnxruntime-gpu==1.19.2 accelerate==0.30.0 "numpy<2"
...
command=python3 /workspace/kohya_ss/kohya_gui.py --listen=0.0.0.0 --headless
autostart=true
autorestart=true
