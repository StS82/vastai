...
pip install -r requirements.txt && pip install bitsandbytes gradio tensorflow onnxruntime-gpu accelerate==0.30.0 numpy==1.26.4 && pip uninstall numpy && pip install numpy==1.26.4
